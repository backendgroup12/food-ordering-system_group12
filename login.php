...
<head>
    <title>Login - Ichiraku's Kitchen</title>
...
<body>
    <main class=".main-body">
        ...
        <div class="login-container">
            ...
            <!-- LEFT SIDE -->
            <div class="left">
                <h1 style=" font-size: 70px; margin-bottom: 15px;">
                    Welcome to Ichiraku's Kitchen
                </h1>
                <p style="font-size: 30px;">Delicious meals delivered to your doorstep.</p>
            </div>
