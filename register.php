...
<head>
    ...
    <title>Register - Ichiraku's Kitchen</title>
...
<body>
    ...
    <section class="regi-section">
        ...
        <form method="POST" enctype="multipart/form-data" class="regi-form">

            <label>First Name:</label><br>
            <input type="text" name="first_name" class="reg-input"> <br><br>

            <label>Last Name:</label><br>
            <input type="text" name="last_name" class="reg-input"><br><br>

            <label>Email:</label><br>
            <input type="email" name="email" class="reg-input"><br><br>

            <label>Enter Password:</label><br>
            <input type="password" name="password" class="reg-input"><br><br>

            <label>Confirm Password:</label><br>
            <input type="password" name="confirm_password" class="reg-input"><br><br>

            <label>Upload Profile Image:</label><br>
            <input type="file" name="profile_image"><br><br>

            <div class="reg-reset-btns">
                <input type="submit" name="register" value="Register" class="cta-button" id="regi-btn">
                <input type="reset" value="Reset" class="cta-button" id="reset-btn">
            </div>
        </form>
